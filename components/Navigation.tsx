...
export function Navigation() {
  ...
  return (
    <nav className="sticky top-0 z-50 border-b border-border bg-background/95 backdrop-blur-sm shadow-sm" data-testid="main-navigation">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <Link href={isSponsor ? "/sponsor" : "/"} className="flex items-center gap-2" data-testid="nav-logo">
            ...
            {isSponsor && (
              <span className="text-xs bg-primary/10 text-primary px-2 py-1 rounded-full" data-testid="sponsor-badge">
                Sponsor
              </span>
            )}
          </Link>
            ...
            {isAuthenticated && profile ? (
              <>
                ...
                >
                  ...
                  />
                  <span className="hidden sm:inline text-sm font-medium text-foreground" data-testid="nav-username">
                    {profile.username}
                  </span>
                </Link>
